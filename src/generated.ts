// Generated by @wagmi/cli@1.1.0 on 6/6/2023 at 5:43:50 PM
import {
  useContractRead,
...
export const iSwivelABI = [
    ...
    inputs: [
      {
        ...
        components: [
          ...
          { name: 'protocol', internalType: 'uint8', type: 'uint8' },
          { name: 'maker', internalType: 'address', type: 'address' },
          { name: 'underlying', internalType: 'address', type: 'address' },
          { name: 'vault', internalType: 'bool', type: 'bool' },
          { name: 'exit', internalType: 'bool', type: 'bool' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'm', internalType: 'uint256', type: 'uint256' },
...
export const myContractABI = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'senderShare', internalType: 'uint8', type: 'uint8' },
  ...
  },
  {
    ...
    inputs: [
      { name: 'p', internalType: 'uint8', type: 'uint8' },
      { name: '_token', internalType: 'contract IERC20', type: 'address' },
      { name: '_maturityDate', internalType: 'uint256', type: 'uint256' },
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iSwivelABI}__ and `functionName` set to `"initiate"`.
 */
export function useISwivelInitiate<TMode extends WriteContractMode = undefined>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<
          typeof iSwivelABI,
    ...
    : UseContractWriteConfig<typeof iSwivelABI, 'initiate', TMode> & {
        abi?: never
        functionName?: 'initiate'
      } = {} as any,
) {
  return useContractWrite<typeof iSwivelABI, 'initiate', TMode>({
    abi: iSwivelABI,
    functionName: 'initiate',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link iSwivelABI}__ and `functionName` set to `"redeemZcToken"`.
 */
export function useISwivelRedeemZcToken<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        'redeemZcToken',
        TMode
      > & { functionName?: 'redeemZcToken' }
    : UseContractWriteConfig<typeof iSwivelABI, 'redeemZcToken', TMode> & {
        abi?: never
        functionName?: 'redeemZcToken'
      } = {} as any,
) {
  return useContractWrite<typeof iSwivelABI, 'redeemZcToken', TMode>({
    abi: iSwivelABI,
    functionName: 'redeemZcToken',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iSwivelABI}__ and `functionName` set to `"initiate"`.
 */
export function usePrepareISwivelInitiate(
  config: Omit<
    UsePrepareContractWriteConfig<typeof iSwivelABI, 'initiate'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'initiate',
    ...config,
  } as UsePrepareContractWriteConfig<typeof iSwivelABI, 'initiate'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link iSwivelABI}__ and `functionName` set to `"redeemZcToken"`.
 */
export function usePrepareISwivelRedeemZcToken(
  config: Omit<
    UsePrepareContractWriteConfig<typeof iSwivelABI, 'redeemZcToken'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'redeemZcToken',
    ...config,
  } as UsePrepareContractWriteConfig<typeof iSwivelABI, 'redeemZcToken'>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link myContractABI}__.
 */
export function useMyContractRead<
  TFunctionName extends string,
  TSelectData = ReadContractResult<typeof myContractABI, TFunctionName>,
>(
  config: Omit<
    UseContractReadConfig<typeof myContractABI, TFunctionName, TSelectData>,
    'abi'
  > = {} as any,
) {
  return useContractRead({
    abi: myContractABI,
    ...config,
  } as UseContractReadConfig<typeof myContractABI, TFunctionName, TSelectData>)
}

/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link myContractABI}__ and `functionName` set to `"deposits"`.
 */
export function useMyContractDeposits<
  TFunctionName extends 'deposits',
  TSelectData = ReadContractResult<typeof myContractABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link myContractABI}__ and `functionName` set to `"owner"`.
 */
export function useMyContractOwner<
  TFunctionName extends 'owner',
  TSelectData = ReadContractResult<typeof myContractABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link myContractABI}__ and `functionName` set to `"swivel"`.
 */
export function useMyContractSwivel<
  TFunctionName extends 'swivel',
  TSelectData = ReadContractResult<typeof myContractABI, TFunctionName>,
>(
  config: Omit<
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link myContractABI}__.
 */
export function useMyContractWrite<
  TFunctionName extends string,
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        PrepareWriteContractResult<
          typeof myContractABI,
          string
        >['request']['abi'],
        TFunctionName,
        TMode
      >
    : UseContractWriteConfig<typeof myContractABI, TFunctionName, TMode> & {
        abi?: never
      } = {} as any,
) {
  return useContractWrite<typeof myContractABI, TFunctionName, TMode>({
    abi: myContractABI,
    ...config,
  } as any)
}
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link myContractABI}__ and `functionName` set to `"deposit"`.
 */
export function useMyContractDeposit<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        TMode
      > & { functionName?: 'deposit' }
    : UseContractWriteConfig<typeof myContractABI, 'deposit', TMode> & {
        abi?: never
        functionName?: 'deposit'
      } = {} as any,
) {
  return useContractWrite<typeof myContractABI, 'deposit', TMode>({
    abi: myContractABI,
    functionName: 'deposit',
    ...config,
  } as any)
...
/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link myContractABI}__ and `functionName` set to `"withdraw"`.
 */
export function useMyContractWithdraw<
  TMode extends WriteContractMode = undefined,
>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<
        ...
        TMode
      > & { functionName?: 'withdraw' }
    : UseContractWriteConfig<typeof myContractABI, 'withdraw', TMode> & {
        abi?: never
        functionName?: 'withdraw'
      } = {} as any,
) {
  return useContractWrite<typeof myContractABI, 'withdraw', TMode>({
    abi: myContractABI,
    functionName: 'withdraw',
    ...config,
  } as any)
...
/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link myContractABI}__.
 */
export function usePrepareMyContractWrite<TFunctionName extends string>(
  config: Omit<
    UsePrepareContractWriteConfig<typeof myContractABI, TFunctionName>,
    'abi'
  > = {} as any,
) {
  return usePrepareContractWrite({
    abi: myContractABI,
    ...config,
  } as UsePrepareContractWriteConfig<typeof myContractABI, TFunctionName>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link myContractABI}__ and `functionName` set to `"deposit"`.
 */
export function usePrepareMyContractDeposit(
  config: Omit<
    UsePrepareContractWriteConfig<typeof myContractABI, 'deposit'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'deposit',
    ...config,
  } as UsePrepareContractWriteConfig<typeof myContractABI, 'deposit'>)
}

/**
 * Wraps __{@link usePrepareContractWrite}__ with `abi` set to __{@link myContractABI}__ and `functionName` set to `"withdraw"`.
 */
export function usePrepareMyContractWithdraw(
  config: Omit<
    UsePrepareContractWriteConfig<typeof myContractABI, 'withdraw'>,
    'abi' | 'functionName'
  > = {} as any,
) {
  return usePrepareContractWrite({
    ...
    functionName: 'withdraw',
    ...config,
  } as UsePrepareContractWriteConfig<typeof myContractABI, 'withdraw'>)
}
